...
router.get("/fetchuserlists", function (req, res) {
    console.log("Inside fetchuserlists");
    ...
    kafka.make_request('fetchuserlists', {data:req.body,username:username} , function (err, results) {
        ...
        if (err) {
          ...
          console.log(results);
          console.log("result received Fetch  User List")
